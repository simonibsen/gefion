...
- **FR-011**: The default modeling universe MUST ship with two initial rules — exclude industry "SHELL COMPANIES" and exclude asset type ETF — and the system MUST report headline universe counts (members, excluded, by rule) in system health output.
