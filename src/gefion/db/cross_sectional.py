...
def insert_cross_sectional_features(
    ...
    """
    with create_span("db.cross_sectional.insert_cross_sectional_features", input_count=len(features)) as span:
        if not features:
        ...
        with conn.cursor(row_factory=dict_row) as cur:
            ...
            set_attributes(span, row_count=len(insert_data), table="cross_sectional_features")
