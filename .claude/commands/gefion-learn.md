...
Checkpoint: learner explains why a backward era-slice can never raise a trust grade (the regime's fitted boundaries *saw* that data — only genuinely-after data is evidence), and why an honest discovery run mostly rejects.
