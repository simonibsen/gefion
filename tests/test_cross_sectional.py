...
def setup_db(db_conn):
    ...
    # Canonical creator (issue #153): fixtures build the table the way
    # db-init does, so schema drift shows up here first.
    schema.create_cross_sectional_features_table(db_conn)
